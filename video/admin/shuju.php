...
<td align="center"><?php if ($zffs==1){echo "微信支付";}elseif ($zffs==2){echo "支付宝支付";}else{echo "其他支付";}?></td>
<td align="center"><?php echo $pid;?></td>
<td align="center"><?php if ($leixing==1){echo "月度会员";}elseif ($leixing==2){echo "季度会员";}elseif ($leixing==3){echo "半年会员";}elseif ($leixing==4){echo "全年会员";}else{echo "金币充值";}?></td>
<td align="center"><?php echo $sctime;?></td>
<td align="center"><?php if ($ddzt==0){echo "未支付";}elseif ($ddzt==1){echo "已支付";}elseif ($ddzt==2){echo "开通成功";}elseif ($ddzt==3){echo "开通失败";}?></td>
