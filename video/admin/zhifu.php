...
<input type="radio" name="zhifu" checked="" value="1" class="demo--radioInput">只显示微信支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="2" class="demo--radioInput">只显示支付宝支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="3" class="demo--radioInput">支付宝和微信都显示&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="5" class="demo--radioInput">只显示第三方支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="4" class="demo--radioInput">只显示卡密支付&nbsp;&nbsp;
<?php }elseif ($zhifu[zhifu]=="2"){ ?>
<input type="radio" name="zhifu"  value="1" class="demo--radioInput">只显示微信支付&nbsp;&nbsp;
<input type="radio" name="zhifu" checked="" value="2" class="demo--radioInput">只显示支付宝支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="3" class="demo--radioInput">支付宝和微信都显示&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="5" class="demo--radioInput">只显示第三方支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="4" class="demo--radioInput">只显示卡密支付&nbsp;&nbsp;
...
<input type="radio" name="zhifu"  value="1" class="demo--radioInput">只显示微信支付&nbsp;&nbsp;
<input type="radio" name="zhifu" value="2" class="demo--radioInput">只显示支付宝支付&nbsp;&nbsp;
<input type="radio" name="zhifu" checked="checked" value="3" class="demo--radioInput">支付宝和微信都显示&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="5" class="demo--radioInput">只显示第三方支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="4" class="demo--radioInput">只显示卡密支付&nbsp;&nbsp;
...
<input type="radio" name="zhifu"  value="3" class="demo--radioInput">支付宝和微信都显示&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="5" class="demo--radioInput">只显示第三方支付&nbsp;&nbsp;
<input type="radio" name="zhifu" checked="checked"  value="4" class="demo--radioInput">只显示卡密支付&nbsp;&nbsp;
<?php }elseif ($zhifu[zhifu]=="5"){ ?>
<input type="radio" name="zhifu"  value="1" class="demo--radioInput">只显示微信支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="2" class="demo--radioInput">只显示支付宝支付&nbsp;&nbsp;
<input type="radio" name="zhifu"  value="3" class="demo--radioInput">支付宝和微信都显示&nbsp;&nbsp;
<input type="radio" name="zhifu" checked="checked"  value="5" class="demo--radioInput">只显示第三方支付&nbsp;&nbsp;
<input type="radio" name="zhifu" value="4" class="demo--radioInput">只显示卡密支付&nbsp;&nbsp;
<?php }?>
</td>
