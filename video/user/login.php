...
$user=getone("select * from ubouser WHERE user='".$username."' and pass='".$newpass."'");
if(!empty($user))
{
$userid=$user['userid'];
...
<div class="botton" >
<input name="reg" type="submit" class="user_reg_but" id="reg" value="登 录">
</div><br>
<div class="botton" >
<input name="reg" type="button" class="user_reg_but" id="reg" value="注册会员"  onclick="location.href='reg.php';">
</div>
<br><br>
</form>
</section>
