...
if($id)
{
$type="email='$email',name='$name',tel='$tel',qq='$qq',alipayname='$alipayname',alipay='$alipay' where id='$id'";
...
<td height="40">
<input type="submit" id="submit" value="保存修改" class="user_reg_but" style="width:120px;">
</td>
</tr>
</tbody></table>
</form>
