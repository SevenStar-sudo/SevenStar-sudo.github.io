...
<td><input name="content" type="text" id="content" style="width:90%" value="恭喜发财，大吉大利！" class="make_resume_input"></td>
</tr>

<tr>
<td height="50" colspan="2" align="center" valign="middle"><input name="url" type="hidden" value="<?php echo $rfr;?>">
  <input type="submit" id="submit" value="塞钱进红包" class="user_reg_but" style="width:120px;"></td>
</tr>
</tbody></table>
</form>
</section>
